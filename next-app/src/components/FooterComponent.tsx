    ...
    <div className="bg-primary">
      <footer className='footer pt-10 px-36 text-primary-content 2xl:max-w-screen-2xl 2xl:mx-auto'>
        ...
        {Object.keys(linksCol1).map( key => (
            <Link className={linksCol1[key].classes} href={linksCol1[key].link} key={key}>{linksCol1[key].text}</Link>
        ))}
        </nav> 
        <nav>
        {Object.keys(linksCol2).map( key => (
            <Link className={linksCol2[key].classes} href={linksCol2[key].link} key={key}>{linksCol2[key].text}</Link>
        ))}
        </nav> 
        <nav>
      ...
      <div className="bg-primary text-primary-content flex flex-col items-center pt-12 pb-6 text-xs">
        <p>
