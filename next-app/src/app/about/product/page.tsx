...
export default function AboutProductPage(): ReactElement {
    ...
    return (
        <div>
            <p>
                The Precision Medicine Portal is part of the <a href="https://www.scilifelab.se/data-driven/about-ddls/precision-medicine-and-diagnostics/" className="underline text-primary">SciLifeLab DDLS node for Precision Medicine and Diagnostics</a> at Karolinska institutet and funded by the <a href="https://kaw.wallenberg.org/en" className="underline text-primary">Knut and Alice Wallenberg Foundation</a>. Launching in autumn 2024, our overall goal is to support Swedish researchers with essential resources within precision medicine (or personalised medicine), such as relevant data sources, interactive data dashboards, data management support, and links to conferences, workshops and other Nordic precision medicine events. 
            </p>
            <p>
