      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 px-4 md:px-0">
        ...
        >
          ...
          <p className="text-sm text-gray-700">
            An overview of accessing clinical data in Sweden, including patient
            and medical records, and quality registers.
          </p>
        </Link>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          >
            ...
            <p className="text-sm mt-1">
              ...
              healthcare improvement and serve as key resources for development
              and research.
            </p>
          </div>
