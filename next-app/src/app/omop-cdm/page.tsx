    ...
    <div className="container mx-auto px-4 py-8">
      ...
      >
        ...
        <p>
          ...
          The Observational Medical Outcomes Partnership (OMOP) was launched in 2008 in the United States as a public–private initiative focused on improving drug safety surveillance and the analysis of observational healthcare data. To enable this work, OMOP introduced a common format for structuring disparate datasets. Over time, the OMOP CDM grew beyond its initial focus on drug development, becoming a widely adopted standard with an independent life of its own, now central to global research across many areas of healthcare.<br/>
