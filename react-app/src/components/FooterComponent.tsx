...
export default function FooterComponent() {
  ...
  var linksCol1: { [id: string] : ILink; } = {
      ...
      'l2': { text: 'Data Search', classes: linkClasses, href: '/#' },
      'l3': { text: 'Data Types', classes: linkClasses, href: '/#' },
      'l4': { text: 'Events & News', classes: linkClasses, href: '/#' },
  };

  var linksCol2: { [id: string] : ILink; } = {
      'l1': { text: 'About us', classes: linkClasses, href: '/#' },
      'l2': { text: 'Contact', classes: linkClasses, href: '/#' },
      'l3': { text: 'Open Source Contribution', classes: linkClasses, href: '/#' },
      'l4': { text: 'Privacy Policy', classes: linkClasses, href: '/#' },
  };
  ...
  return (
    <footer className="footer p-10 bg-base-300 text-base-content fixed bottom-0">
      ...
      {Object.keys(linksCol2).map( key => (
          <a className={linksCol2[key].classes} href={linksCol2[key].href}>{linksCol2[key].text}</a>
      ))}
      </nav> 
      <nav>
